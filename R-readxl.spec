...
%setup -q -n readxl
pushd ..
cp -a readxl buildavx2
popd
pushd ..
cp -a readxl buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1737155533
...
/usr/lib64/R/library/readxl/tests/testthat/_snaps/col-names.md
/usr/lib64/R/library/readxl/tests/testthat/_snaps/col-types.md
/usr/lib64/R/library/readxl/tests/testthat/_snaps/dates.md
/usr/lib64/R/library/readxl/tests/testthat/_snaps/problems.md
/usr/lib64/R/library/readxl/tests/testthat/_snaps/read-excel.md
/usr/lib64/R/library/readxl/tests/testthat/_snaps/sheets.md
/usr/lib64/R/library/readxl/tests/testthat/helper.R
/usr/lib64/R/library/readxl/tests/testthat/setup.R
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/R/library/readxl/libs/readxl.so
/V4/usr/lib64/R/library/readxl/libs/readxl.so
